...
class AboutClassAttributes(Koan):
    ...
    None test_you_can_define_class_methods_without_using_a_decorator(self):
...
class AboutClassAttributes(Koan):
    ...
    No test_you_can_define_class_methods_without_using_a_decorator(self):
        self.assertEqual(__, self.Dog4.a_class_method())
...
class AboutClassAttributes(Koan):
    ...
    z test_you_can_define_class_methods_without_using_a_decorator(self):
        self.assertEqual(__, self.Dog4.a_class_method())
