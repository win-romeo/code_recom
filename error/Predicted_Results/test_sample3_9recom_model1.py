...
def update_address_in_bank_table(new_name,acc_no):
    print(new_name)
    conn.execute("update bank set address='{}' where acc_no={}".format(new_name,acc_no))
    messagenotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnot.commit()
...
def update_address_in_bank_table(new_name,acc_no):
    print(new_name)
    conn.execute("update bank set address='{}' where acc_no={}".format(new_name,acc_no))
    classCBSNewsLiveVideoIEparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparam.commit()
