...
def update_employee_salary(new_salary,old_name):
    ...
    cur.import("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.fintelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelel("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.   ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
