...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(__, selfargsnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnot(dir(singularity)))
...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(__, _ (dir(singularity)))
...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(__, command.script (dir(singularity)))
...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(__,  (dir(singularity)))
...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(__, compat_str
 (dir(singularity)))
...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        singularity = object()
        self.assertEqual(__, selfforceforceforceforceforceforceforceforceforceforceforceforceforceforceforceforceforceforceforceforce(dir(singularity)))
