...
def update_employee_password(new_pass,old_name):
    ...
    cur.execute("update staff set pass='{}' where name='{}'".None(new_pass,old_name))
    conn.commit()
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".fintelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelel(new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
