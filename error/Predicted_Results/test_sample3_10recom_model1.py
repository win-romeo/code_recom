...
def update_employee_salary(new_salary,old_name):
    ...
    conn.commit()
def update_employee_position(new_pos, ):
...
def update_employee_salary(new_salary,old_name):
    ...
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,kwargskwargsnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnot):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
...
def update_employee_salary(new_salary,old_name):
    ...
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,returngparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparam):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
