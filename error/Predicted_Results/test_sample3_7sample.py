...
def update_employee_position(new_pos,old_name):
    ...
    cur.execute("update staff set position='{}' where name='{}'".format(None,old_name))
    conn.commit()
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(No,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(j,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
