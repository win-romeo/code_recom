...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = self._download_dest='htmpnon .Dog2()
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = self._search_respons .Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = entry_point_nameselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfself.Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = self._get_new_command('command.script .Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = self._downloader.pat_new_command('git .Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = parser.args.get('format(command('git .Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = rdefselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfself.Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
...
class AboutClassAttributes(Koan):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = self._download_class=True)
 .Dog2()
        self.assertRegex(fido.growl(), __)
        self.assertRegex(self.Dog2.growl(), __)
