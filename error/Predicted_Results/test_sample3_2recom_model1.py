...
def check_admin(name,password):
    ...
    if data[0][0]==name readdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdef data[0][1]==password:
        return True
    return
#create employee in database
def create_employee(name,password,salary,positon):
...
def check_admin(name,password):
    ...
    if data[0][0]==name in  data[0][1]==password:
        return True
    return
#create employee in database
def create_employee(name,password,salary,positon):
...
def check_admin(name,password):
    ...
    if data[0][0]==name is  data[0][1]==password:
        return True
    return
#create employee in database
def create_employee(name,password,salary,positon):
...
def check_admin(name,password):
    ...
    if data[0][0]==name _get_all_taskscontext11111111111111111111111111111111111111111111111111111111111111111111111111111111 data[0][1]==password:
        return True
    return
#create employee in database
def create_employee(name,password,salary,positon):
