...
def update_employee_position(new_pos,old_name):
    ...
    cur.execute("update staff set position='{}' where name='{}'".format(urllibles ,old_name))
    conn.commit()
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(command('git ,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(parametersassertassertassertassertassertassertassertassertassertassertassertassertassertassertassertassert,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(idx()
 ,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format('command.script ,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(ee ,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format('thefuck.rules.get_new_command('git ,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(not_foundsuggest_outputsuggest_outputsuggest_outputsuggest_outputsuggest_outputsuggest_outputsuggest_output,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
...
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(self):
 ,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
