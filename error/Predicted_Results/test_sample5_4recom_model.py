...
class AboutClassAttributes(Koan):
    ...
    def test_classes_and_instances_do_not_share_instance_attributes(self):
        ...
        self.mat,(__, self.Dog3.get_name())
...
class AboutClassAttributes(Koan):
    ...
    def test_classes_and_instances_do_not_share_instance_attributes(self):
        ...
        fido.set_name("Rover")
        self.assertEqual(__, fido.get_name_from_instance())
        self.fintelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelel(__, self.Dog3.get_name())
