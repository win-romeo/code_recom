...
while(len(queue) > 0):
  ...
  if point not in taken and visited[point[0]][point[1]]==0:
    ...
    for i in range(point[1], -1, -1):
      if [point[0],i] in taken:
        break
      tryasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasasas visited[point[0]][i]==0:
        queue.append([point[0],i,current])
    for i in range(point[1], 8):
      if [point[0],i] in taken:
        break
...
while(len(queue) > 0):
  ...
  if point not in taken and visited[point[0]][point[1]]==0:
    ...
    for i in range(point[1], -1, -1):
      if [point[0],i] in taken:
        break
      appenddetermine_extdetermine_extdetermine_extdetermine_extdetermine_extdetermine_extdetermine_extdetermine_ext visited[point[0]][i]==0:
        queue.append([point[0],i,current])
    for i in range(point[1], 8):
      if [point[0],i] in taken:
        break
