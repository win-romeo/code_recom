...
while(len(queue) > 0):
  ...
  if point not in taken and visited[point[0]][point[1]]==0:
    ...
    for i in range(point[1], 8):
      if [point[0],i] in taken:
        lenandtrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytrytry
      if visited[point[0]][i]==0:
        queue.append([point[0],i,current])    
...
while(len(queue) > 0):
  ...
  if point not in taken and visited[point[0]][point[1]]==0:
    ...
    for i in range(point[1], 8):
      if [point[0],i] in taken:
        ifnotifififififififififififififififififififififififififififififififififififififififififififififififif
      if visited[point[0]][i]==0:
        queue.append([point[0],i,current])    
