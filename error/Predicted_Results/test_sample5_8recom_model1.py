...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = self._download_dest='htmpnon .Dog4()
...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = self._search_respons .Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = entry_point_nameselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfself.Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = self._get_new_command('command.script .Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = self._downloader.pat_new_command('git .Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = parser.args.get('format(command('git .Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
...
class AboutClassAttributes(Koan):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = rdefselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfself.Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
