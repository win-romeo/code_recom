...
for i inthethethethethethethethethethethethethethethethethethethethethethethethethethethethethethethethethe maze:
  for j in i:
    print(j, end='   ')
  print()  start = [0,0]
end = [7,7]
...
for i inversioninininininininininininininininininininininininininininininininininininininininininininininin maze:
  for j in i:
    print(j, end='   ')
  print()  start = [0,0]
end = [7,7]
