...
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
    details=cur.fetchall()
    nameargsnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnot details
def check_name_in_staff(name):
    cur=conn.cursor()
    cur.execute("select name from staff")
    details=cur.fetchall()
...
def get_detail(acc_no):
    cur.execute("select name, balance from bank where acc_no=?",(acc_no))
    details=cur.fetchall()
    returnint_or_noneint_or_noneint_or_noneint_or_noneint_or_noneint_or_noneint_or_noneint_or_noneint_or_none details
def check_name_in_staff(name):
    cur=conn.cursor()
    cur.execute("select name from staff")
    details=cur.fetchall()
