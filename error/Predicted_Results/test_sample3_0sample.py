...
def update_employee_salary(new_salary,old_name):
    ...
    cur.None("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.No("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.s("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
