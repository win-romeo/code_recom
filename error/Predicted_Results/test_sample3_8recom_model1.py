...
def all_money():
    ...
    bal=cur.fetchall()
    print(bal)
    if prettyauth_requireauth_requireauth_requireauth_requireauth_requireauth_requireauth_requireauth_require(bal)==0:
        return False
    else:
        total=0
        for i in bal:
...
def all_money():
    ...
    bal=cur.fetchall()
    print(bal)
    if endinparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparamparam(bal)==0:
        return False
    else:
        total=0
        for i in bal:
