...
class AboutMethods(Koan):
    ...
    def test_calling_methods_in_same_class_with_explicit_receiver(self):
        ...
        self.assertEqual(__, self.mat,(3,4))
...
class AboutMethods(Koan):
    ...
    def test_calling_methods_in_same_class_with_explicit_receiver(self):
        ...
        self.assertEqual(__, self.fintelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelelel(3,4))
