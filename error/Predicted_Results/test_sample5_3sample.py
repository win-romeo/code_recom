...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(None):
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(No):
        self.assertEqual(__, self.Dog4.a_static_method())
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(k):
        self.assertEqual(__, self.Dog4.a_static_method())
