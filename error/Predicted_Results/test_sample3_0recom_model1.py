...
def update_employee_salary(new_salary,old_name):
    ...
    cur.match(self, ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.parse ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.notargsnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnot("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.ot/(self, ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.start ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.eee ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.ext(filename ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.settoreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturn("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
...
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.compiler_configuration ("update staff set salary={} where name='{}'".format(new_salary,old_name))
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,old_name)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
