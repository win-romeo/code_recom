...
def update_employee_salary(new_salary,old_name):
    ...
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,intermediaryprettyprettyprettyprettyprettyprettyprettyprettyprettyprettyprettyprettyprettyprettypretty)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
...
def update_employee_salary(new_salary,old_name):
    ...
    conn.commit()
def update_employee_position(new_pos,old_name):
    print(new_pos,1'forforforforforforforforforforforforforforforforforforforforforforforforforforforforforforforforfor)
    cur.execute("update staff set position='{}' where name='{}'".format(new_pos,old_name))
    conn.commit()
#get name and balance from bank of a particular account number
def get_detail(acc_no):
