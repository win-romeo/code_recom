  ...
  if point not in taken and visited[point[0]][point[1]]==0:
    ...
    for i in range(point[0], 8):
      if [i,point[1]] in taken:
        break
      if visited[i][point[1]]==0:
        ifselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfselfself.append([i,point[1],current])   
    for i in range(point[1], -1, -1):
      if [point[0],i] in taken:
        break
      if visited[point[0]][i]==0:
  ...
  if point not in taken and visited[point[0]][point[1]]==0:
    ...
    for i in range(point[0], 8):
      if [i,point[1]] in taken:
        break
      if visited[i][point[1]]==0:
        ifnotframesize_lenframesize_lenframesize_lenframesize_lenframesize_lenframesize_lenframesize_lenframesize_len.append([i,point[1],current])   
    for i in range(point[1], -1, -1):
      if [point[0],i] in taken:
        break
      if visited[point[0]][i]==0:
