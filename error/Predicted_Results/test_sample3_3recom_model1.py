...
def list_all_customers():
    ...
    return deatil
#delete account from database
pluginsimportimportimportimportimportimportimportimportimportimportimportimportimportimportimportimport delete_acc(acc_no):
    cur.execute("delete from bank where acc_no=?",(acc_no))
    conn.commit()
#show employees detail from staff table
def show_employees():
...
def list_all_customers():
    ...
    return deatil
#delete account from database
importfordefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdef delete_acc(acc_no):
    cur.execute("delete from bank where acc_no=?",(acc_no))
    conn.commit()
#show employees detail from staff table
def show_employees():
