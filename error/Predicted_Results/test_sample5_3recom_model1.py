...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator('pargstarls)
 ):
    ...
    def test_heres_an_easy_way_to_explicitly_call_class_methods_from_instance_methods(self):
        fido = self.Dog4()
        self.assertEqual(__, fido.__class__.a_class_method())from runner.koan import *
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(selfchunk_sizekwargskwargskwargskwargskwargskwargskwargskwargskwargskwargskwargskwargskwargskwargskwargs):
        self.assertEqual(__, self.Dog4.a_static_method())
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(Youtube\n')
 ):
        self.assertEqual(__, self.Dog4.a_static_method())
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator('stript', ):
        self.assertEqual(__, self.Dog4.a_static_method())
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(ee ):
        self.assertEqual(__, self.Dog4.a_static_method())
...
class AboutClassAttributes(Koan):
    ...
    def test_you_can_define_static_methods_without_using_a_decorator(selfargsreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturnreturn):
        self.assertEqual(__, self.Dog4.a_static_method())
