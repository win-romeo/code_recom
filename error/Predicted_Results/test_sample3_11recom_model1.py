...
def get_details(acc_no):
    cur.execute("select * from bank where acc_no=?",(acc_no))
    global detail
    detail = cur.notargsnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnotnot()
    print(detail)
    if len(detail)==0:
        return False
    else:
...
def get_details(acc_no):
    cur.execute("select * from bank where acc_no=?",(acc_no))
    global detail
    detail = cur.compiler_configuration ()
    print(detail)
    if len(detail)==0:
        return False
    else:
