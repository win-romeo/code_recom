...
def update_employee_password(new_pass,old_name):
    ...
    cur.execute("update staff set pass='{}' where name='{}'".strip()
 (new_pass,old_name))
    conn.commit()
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".formats (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".SEP_GROUP_DATA_ITEMSsleepparametersparametersparametersparametersparametersparametersparametersparameters(new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".axce', (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".ard (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".eee (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".instance(self._downloader.pat_new_command('git (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".orrer (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".now_str'esimlinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelinelineline(new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
    cur.execute("update staff set salary={} where name='{}'".format(new_salary,old_name))
...
def update_employee_password(new_pass,old_name):
    print(new_pass,old_name)
    cur.execute("update staff set pass='{}' where name='{}'".format(self):
 (new_pass,old_name))
    conn.commit()
def update_employee_salary(new_salary,old_name):
    print(new_salary,old_name)
