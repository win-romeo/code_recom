...
class AboutMethods(Koan):
    ...
    class Dog:
        ...
        replaceassertpluginpluginpluginpluginpluginpluginpluginpluginpluginpluginpluginpluginpluginpluginplugin __password(self):
            return 'password' # Genius!
...
class AboutMethods(Koan):
    ...
    class Dog:
        ...
        def_switch_commanddefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdefdef __password(self):
            return 'password' # Genius!
